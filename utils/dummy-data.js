...
export const MEALS = [
...

  {
    ...
    complexity: "simple",
    imageUrl:
      "https://images.unsplash.com/photo-1550547660-d9450f859349?auto=format&fit=crop&w=800&q=80", // Real hamburger
    duration: 45,
    ingredients: [
      "300g Cattle Hack",
      "1 Tomato",
  ...
  // Italian dish 2
  {
    ...
    steps: [
      ...
      "Drizzle with olive oil and bake at 220°C for 12-15 min.",
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: true,
  ...
  // Hamburger dish 2
  {
    ...
    steps: [
      "Grill patties, melt cheese on top.",
      "Toast buns, assemble with veggies and sauces.",
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: false,
  ...
  // New dish 1
  {
    ...
    steps: [
      ...
      "Slice salmon, avocado, and cucumber into strips.",
      "Place nori on bamboo mat, spread rice evenly.",
      "Add fillings and roll tightly.",
      "Slice rolls and serve with soy sauce, wasabi, and ginger.",
    ],
    isGlutenFree: true,
    isVegan: false,
    isVegetarian: false,
  ...
  // New dish 3
  {
    ...
    steps: [
      ...
      "Heat cream and vanilla bean until just boiling.",
      "Whisk egg yolks and sugar, then slowly add cream.",
      "Pour into ramekins and bake in water bath for 40 min.",
